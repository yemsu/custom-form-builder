...
개발자 간의 환경 일관성을 유지하고 의존성 관리를 단순화하기 위해 Docker를 통한 개발 환경을 지원합니다. 구동 방법은  **2.설치 및 실행 가이드의 2.1 개발 환경 설정**을 확인해주세요.
...
미리보기 영역의 자세한 설명은 **3.2 양식 수정 페이지 > 미리 보기 영역**에서 확인하실 수 있습니다.
